...
<img width="1920" height="1080" alt="Screenshot" src="https://github.com/user-attachments/assets/415e2cd2-1546-4597-afc6-22913d50fd49" />
...
## Renderer
DR3FP also has a rendering application that can output a video of your chart. It offers better consistency and speed (potentially faster than real-time) compared to traditional screen recording. It is Windows-exclusive.<br>

You are required to download a FFMPEG executable (ffmpeg.exe) yourself. I recommend downloading it from [here](https://www.gyan.dev/ffmpeg/builds/).<br>

<img width="1917" height="1080" alt="Screenshot" src="https://github.com/user-attachments/assets/5226a5f0-e467-4e2f-95b1-a1f8ae7f192d" />
